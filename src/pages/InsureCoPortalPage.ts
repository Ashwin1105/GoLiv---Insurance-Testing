...
export const TEST_CASES: Record<string, TestCaseInfo> = {
  TC_LIF_011: {
    id: 'TC_LIF_011',
    status: 'PASS',
  ...
  TC_EC_001: {
    ...
    steps:
      'Step 1: Open claim intimation screen Step 2: Leave claim type field blank Step 3: Fill policy number and other mandatory fields Step 4: Submit claim Step 5: Observe system response',
    expected:
  ...
  TC_EC_002: {
    ...
    steps:
      'Step 1: Access claim intimation form Step 2: Enter claim type but leave policy number empty Step 3: Provide claimant details and submit',
    expected:
  ...
  TC_EC_003: {
    ...
    steps:
      'Step 1: Open claim entry screen Step 2: Enter claim type Step 3: Input policy number as \'@#%$!123\' Step 4: Submit claim',
    expected:
  ...
  TC_EC_004: {
    ...
    steps:
      'Step 1: Open claim lodgement screen Step 2: Leave intimation date field blank Step 3: Complete other mandatory fields and submit',
    expected:
  ...
  TC_EC_005: {
    ...
    steps:
      'Step 1: Open claim entry form Step 2: Enter intimation date as 2026-10-01 Step 3: Fill other required fields and submit',
    expected:
  ...
  TC_EC_006: {
    ...
    steps:
      'Step 1: Lodge death claim Step 2: System records claim Step 3: Observe payment processing timeline',
    expected:
  ...
  TC_EC_007: {
    ...
    steps:
      'Step 1: Process claim payment on 2026-09-02 (31 days after docs receipt) Step 2: Check SLA monitoring module',
    expected:
  ...
  TC_EC_008: {
    ...
    steps:
      'Step 1: Perform investigation activities Step 2: Mark investigation as completed on 2026-08-30 (90th day) Step 3: Verify SLA status',
    expected:
  ...
  TC_EC_009: {
    ...
    steps:
      'Step 1: Complete investigation on 2026-07-01 (91st day) Step 2: Review SLA monitoring report',
    expected:
  ...
  TC_EC_010: {
    ...
    steps:
      'Step 1: System sends acknowledgment email on Monday, 2026-09-12 Step 2: Verify acknowledgment timestamp against SLA rule',
    expected:
  ...
  TC_EC_011: {
    ...
    steps:
      'Step 1: System dispatches acknowledgment on Friday, 2026-09-09 (fourth working day) Step 2: Check SLA compliance module',
    expected:
  ...
  TC_EC_012: {
    ...
    steps:
      'Step 1: Submit suicide death claim Step 2: System identifies suicide within 12‑month window Step 3: System computes refund amount',
    expected:
  ...
  TC_EC_013: {
    ...
    steps:
      'Step 1: Lodge suicide claim Step 2: System calculates policy age as 12 months Step 3: System determines applicable refund percentage',
    expected:
  ...
  TC_EC_014: {
    ...
    steps:
      'Step 1: Submit claim with suicide cause Step 2: System checks policy age >12 months Step 3: System calculates refund amount',
    expected:
  ...
  TC_EC_015: {
    ...
    steps:
      'Step 1: Submit claim with diagnosis date equal to policy issuance date Step 2: System calculates accelerated amount Step 3: Verify payout includes INR 125,000 (25% of SA) as accelerated benefit',
    expected:
  ...
  TC_EC_016: {
    ...
    steps:
      'Step 1: Lodge claim indicating diagnosis date Step 2: System computes 25% of INR 2,500,000 Step 3: Verify accelerated amount equals INR 625,000',
    expected:
  ...
  TC_EC_017: {
    ...
    steps:
      'Step 1: Submit accidental death claim Step 2: System aggregates base SA and rider SA Step 3: System applies INR 1 Crore ceiling Step 4: Verify payout amount',
    expected:
  ...
  TC_EC_018: {
    ...
    steps:
      'Step 1: Lodge accidental death claim Step 2: System adds base SA and rider SA Step 3: Verify total does not exceed INR 1 Crore Step 4: Confirm full payout of INR 5,50,00,000',
    expected:
  ...
  TC_EC_019: {
    ...
    steps:
      'Step 1: Attempt to lodge a claim with the malformed policy number Step 2: System validates policy number format Step 3: System returns error message',
    expected:
      'Claim is rejected with error "Invalid policy number".',
  },
  TC_EC_020: {
    id: 'TC_EC_020',
    status: 'NOTRUN',
    ...
    steps:
      'Step 1: Submit claim with the non‑existent policy number Step 2: System performs lookup against policy repository Step 3: System returns error message',
    expected:
      'Claim is rejected with error "Policy number not found".',
  },
};
